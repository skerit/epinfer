...
// "-EVOLVE" & "-lol"
release_group.addExtract(/-([A-Z\-0-9]+)$/, 80).positionBefore('website').positionAfter('title');

// "-EVOLVE.ext" & "-lol.ext"
release_group.addExtract(/-([A-Z\-0-9]+)\.[a-z]{2,3,4,5}$/, 80).positionBefore('website').positionAfter('title');

// "-EVOLVE" & "-lol"
release_group.addExtract(/-([A-Z0-9\-]+)/i, 50).positionBefore('website').positionAfter('title');
