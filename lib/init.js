...
subtitle.addMatch('fre', 'VOSTFR', 90);
subtitle.addExtract(/\bsub[\W_]([A-Z]{2,})/, 80);

// Language
var language = episode.addProperty('language', 'language');
language.addExtract(/\b(FRENCH)\b/, 90);
language.addExtract(/\b(ENG)\b/, 90);
language.addExtract(/\b(FR)\b/, 50);
language.addExtract(/\b(fre)\b/, 50);
language.addExtract(/\b(VF)\b/, 50);
