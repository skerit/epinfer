...
Epinfer.setMethod(function process(filename) {
	...
	if (this.result.container) {
		this.result.container = this.result.container.slice(1);
	}

	this.result.quality = this.quality;
...
// Register the types
instance.registerProperty('type', 'readme', [/\.txt$/, /\.log$/], -30);
instance.registerProperty('type', 'info', [/\.nfo$/], -20);
instance.registerProperty('type', 'subtitle', [/\.srt$/, /\.idx$/, /\.sub$/, /\.ssa$/, /\.ass$/], -10);
instance.registerProperty('type', 'video', [/\.3g2$/, /\.3gp$/, /\.3gp2$/, /\.asf$/, /\.avi$/, /\.divx$/, /\.flv$/, /\.m4v$/, /\.mk2$/,
/\.mka$/, /\.mkv$/, /\.mov$/, /\.mp4$/, /\.mp4a$/, /\.mpeg$/, /\.mpg$/, /\.ogg$/, /\.ogm$/,
/\.ogv$/, /\.qt$/, /\.ra$/, /\.ram$/, /\.rm$/, /\.ts$/, /\.wav$/, /\.webm$/, /\.wma$/, /\.wmv$/,
/\.iso$/], 10);

instance.registerProperty('container', 0, [/\.3g2$/, /\.3gp$/, /\.3gp2$/, /\.asf$/, /\.avi$/, /\.divx$/, /\.flv$/, /\.m4v$/, /\.mk2$/,
/\.mka$/, /\.mkv$/, /\.mov$/, /\.mp4$/, /\.mp4a$/, /\.mpeg$/, /\.mpg$/, /\.ogg$/, /\.ogm$/,
/\.ogv$/, /\.qt$/, /\.ra$/, /\.ram$/, /\.rm$/, /\.ts$/, /\.wav$/, /\.webm$/, /\.wma$/, /\.wmv$/,
/\.iso$/], 10);
